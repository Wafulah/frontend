  ...
  return (
    <div className="home">
      <div className="holder">
        ...
        <div>
          <div className="mt-10">
            <h2 className="text-center head-text">We Build Brands</h2>
          </div>
          <div className="flex justify-between mt-10">
            <div className="float-left h-96 w-80">
              <p className="text-white text-sm opacity-50 align-left py-2.5">
                To ensure you get recognized through Graphic Design, Print Media
                and Web Design, to ensure long term satisfaction.
              </p>
              <p className="text-white text-md py-2.5">10000+</p>
              <p className="text-white text-sm opacity-50 align-left">
                Finished Projects
              </p>
              <p className="text-white text-md pt-6 py-2.5 ">5000+</p>
              <p className="text-white text-sm opacity-50 align-left">
                Satisfied Customers
              </p>
            </div>
            ...
            <div className="float_right text-right float-right h-96 w-80">
              <p className="text-white  text-md py-2.5">15+</p>
              <p className="text-white  text-sm opacity-50 align-left">
                Dedicated Designers
              </p>
              <p className="text-white  text-md pt-6 py-2.5 ">70+</p>
              <p className="text-white  text-sm opacity-50 align-left">
                Ongoing Projects
              </p>

              <p className="text-white pt-6 text-sm opacity-50 align-left py-2.5">
